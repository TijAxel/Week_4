...
#.count() menthod counts the number of times
# a substring appears in a string

#startswith() method checks if a string starts ith a specific substring
...
#.replace() method checks if a string ends with a specific substring
print(new_text.replace("text",world"))
